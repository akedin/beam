 ...
 * BeamPlannerImpl.
 */
public class BeamPlannerImpl extends PlannerImpl {
  ...
  public BeamPlannerImpl(FrameworkConfig config) {
    super(config);
    this.config = config;
  ...
  private void ready() {
    ...
    Frameworks.withPlanner((Frameworks.PlannerAction<Void>) (cluster, relOptSchema, rootSchema) -> {
...
//    root = root.withRel(RelDecorrelator.decorrelateQuery(root.rel));
  ...
  public class ViewExpanderImpl implements RelOptTable.ViewExpander {
    @Override public RelRoot expandView(RelDataType rowType, String queryString,
      ...
      return BeamPlannerImpl.this.root;
    }
  }
  ...
  private enum State {
    STATE_0_CLOSED {
      @Override void from(BeamPlannerImpl planner) {
        planner.close();
      }
    },
    STATE_1_RESET {
    ...
    void from(BeamPlannerImpl planner) {
